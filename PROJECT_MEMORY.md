...
- 阶段：V1 八字、V2 塔罗为本地 RC；V3 紫微为校盘版；V4 合缘为 RC。
- 当前工作：进行最新视觉回归，以及 V1/V2/V3/V4 联合人工验收。
- 尚未开始：正式上线、云端持久化、账户/跨设备同步、上线后 D 类验收。
- 最新功能基线：`7641126`；记忆文档版本以 Git 历史为准，不在正文循环追写提交号。
...
4. 验收 V3.1 紫微前端；随后完成至少 30 盘校对与闰月口径决策。
5. 完成紫微解释层、全站视觉收尾与多设备回归。
